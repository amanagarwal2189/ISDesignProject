...
public class Host {
	...
	public Host(String name, String email_id, String phone, String address_line_1, String address_line_2, String city,
			String state, int zip, boolean is_active, Date regd_on, String password) {
		super();
		this.name = name;
		this.emailId = email_id;
		this.phone = phone;
